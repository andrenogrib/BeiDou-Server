...
function start(mode, type, selection)
{
	if (CheckStatus(mode))
	{
	    ...
	    {
			//第一层对话
			qm.sendAcceptDecline("Hey, you, the new adventurer, do you want to learn a bit about this place?");
	    }
		else if (status == 1 )
		{
			//第二层对话
			var text = "A wise choice. This place is called Toy Town, where there are many villagers and monsters made of LEGO bricks.";
			text += "Of course, there are also plenty of monsters. Look, the one on the right is the most common in Toy Town, #b#o9409001##k. Hunt 5 of them for me, and I'll give you some rewards for your adventures...";
			qm.sendOk(text);
			qm.forceStartQuest();
            qm.dispose();	
		}
...
function end(mode, type, selection)
{
	if (CheckStatus(mode))
	{
	    ...
	    {
			//第一层对话
            qm.sendNext("Not bad! Did the quest go smoothly? Here's the reward I promised you\r\n\r\n#fUI/CashShop.img/CSDiscount/bonus# Mesos: 10000");
            qm.gainMeso(10000);			
